...
def build_counter_parametric_knowledge(
    ...
    selected_counter_objects = [
        (obj, log_prob) for obj, log_prob in objects_to_first_token_log_probas if obj in valid_objects
    ]

    counter_parametric_knowledge = []
    for counter_object, log_prob_counter_object in selected_counter_objects[:nb_counter_parametric_knowledge]:
        ...
        counter_parametric_knowledge.append(
            {
                ...
                "counter_knowledge_object_first_token_id": all_dataset_objects_to_their_first_token_id[counter_object],
                "log_prob_counter_object": log_prob_counter_object,
                "log_prob_parametric_object": max(parametric_object_first_token_log_probas_distribution),
                "statement": statement,
                "statement_query": f"{statement_subject.strip()} {statement_relation.strip()}",
                "parametric_knowledge_object": parametric_object,
                "parametric_knowledge_first_token_id": all_dataset_objects_to_their_first_token_id[parametric_object],
